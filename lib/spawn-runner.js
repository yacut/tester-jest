...
function parseReporterOutput(data/* :string*/, filePath/* :string*/, textEditor /* :TextEditor*/, testLocations/* :?Array<itBlock>*/)/* :Promise<Array<message>>*/ {
  return new Promise((res, rej) => {
    ...
    } else if (hasAssertionResults) {
      forEach(dataJSON.testResults[0].assertionResults, (testResult) => {
